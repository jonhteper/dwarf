...
use crate::{win_options, App, Color32, RadioOption, Step, Vec2};
use chrono::Utc;
use eframe::run_native;
use egui::{Button, CentralPanel, Response, RichText, Style, TextEdit};
...
impl SatApp {
    ...
    fn ui_manual_button(&mut self, ui: &mut egui::Ui) {
        ui.horizontal(|ui| {
            let button_man = ui.add(Button::new("Ayuda"));
            if button_man.clicked() {
                // TODO launch manual window
            }
        });
    }
